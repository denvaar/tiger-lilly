defmodule TigerLillyWeb.PostControllerTest do
  use TigerLillyWeb.ConnCase

  alias TigerLilly.Blog

  @create_attrs %{body: "some body", date_published: "2010-04-17 14:00:00.000000Z", published: true, summary: "some summary", title: "some title"}
